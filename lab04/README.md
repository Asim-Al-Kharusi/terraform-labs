...
## Diagnostic Setting
Now that a key vault has been declared, it would be useful to have the metrics and logs from the key vault collected centrally. I have chosen to create a diagnostic setting for the key vault with the destination being the log analytics workspace I set up in Lab03. **This was a good way to practice calling data sources of exsisting resources.**
